<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Contact.aspx.cs" Inherits="online" %>
            ...
            <td class="style140" colspan="2" style="background-color: #FFFFFF">
                <table class="style141">
                    ...
                    <tr>
                        ...
                        <td class="style143">
                            <asp:Image ID="Image2" runat="server" Height="285px" ImageUrl="~/contactus.jpg" 
                                Width="295px" />
                        </td>
                        <td align="center" class="style172" colspan="3">
                            Email-id&nbsp;&nbsp;&nbsp;&nbsp; <a href="mailto:dakshinathapamangar@gmail.com">
                            dakshinathapamangar@gmail.com</a><br />
&nbsp;Phone: 7602535895, 8513050336</td>
                    </tr>
                    <tr>
                        <td class="style171">
                            &nbsp;</td>
