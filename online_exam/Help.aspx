...
<body>
    ...
    <table class="style1" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td class="style43" colspan="2" bgcolor="DimGray">
                </td>
        </tr>
        <tr>
            ...
            <td class="style140" colspan="2" style="background-color: #FFFFFF">
                <table class="style141">
                    ...
                    <tr>
                        ...
                        <td class="style143">
                            <asp:Image ID="Image2" runat="server" Height="285px" ImageUrl="~/help-logo.png" 
                                Width="295px" />
                        </td>
                        <td align="center" class="style172" colspan="3">
                            &nbsp; Online Examination reduce the huge work done by teachers,administrators and 
                            also students.To start with the Online Examination System, you need to register 
                            first if you are a new user else you can login with your email-id and passeword 
                            which will direct you to homepageand from their you can choose your respective 
                            topic and perform an exam. Result will be shown immediately after submitting the 
                            whole answer.</td>
                    </tr>
                    <tr>
                        <td class="style171">
